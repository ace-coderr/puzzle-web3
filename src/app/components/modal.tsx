...
export default function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-md bg-black/70">
      <div
        className={`relative w-full max-w-lg p-10 rounded-3xl shadow-2xl border-2 ${bgColor} ${borderColor} text-white transform transition-all animate-in fade-in zoom-in duration-300`}
      >
